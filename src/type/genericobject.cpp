...
GenericObject::GenericObject(ObjectTypeInterface *type, void *value, const boost::optional<ObjectUid>& maybeObjectUid)
  : type(type)
  , value(value)
  , uid(maybeObjectUid ? *maybeObjectUid : os::ptrUid(value))
{
}
